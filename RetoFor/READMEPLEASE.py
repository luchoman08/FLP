#ESTUDIANTE: Luis Gerardo Manrique Cardona
#CODIGO: 20132791
...
#pero si se quiere conocer, luego de ejecutar un for puede escribirse en el interpretador "fore" como 
#si se estuviese llamando una variable o bien escribir en el interpretador "execute fore(1,10)" y comparar
#esto con los resultados de la ejecuciòn del ultimo for (y mirar la función parse-for-to-recursive-closure)
